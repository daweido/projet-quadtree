...
let thirdPageVBoxview3 = GPack.vbox
	~spacing:10
	~show: false
	~packing: firstVbox#add ()
...
let alignImageViewSecondView = GBin.alignment
	...
	~xscale:0.0
	~yscale:0.0
	~packing:thirdPageVBoxview3#add ()
...
(*RightToolbar*)
let bottomToolbarSecondView = GButton.toolbar
	~orientation: `HORIZONTAL
	~style:`BOTH
	~packing:(thirdPageVBoxview3#pack ~expand:false) ()

let tablebottomToolbarSecondView = GPack.table
	~rows:1
	~columns:5
	~col_spacings:100
	~border_width:5 ();;
...
let topToolbarRadioview3 = GButton.radio_button
	~label:"View 2"
...
ignore (topToolbarTable#attach ~left:1 ~top:0 (topToolbarRadioview3#coerce));
...
ignore (bottomToolbarSecondView#insert_widget ~tooltip:"Right Toolbar" (tablebottomToolbarSecondView#coerce));
ignore (tablebottomToolbarSecondView#attach ~left:0 ~top:0 (alignTableRotToolbarSecondView#coerce));;
...
ignore (tablebottomToolbarSecondView#attach ~left:1 ~top:0 (alignTableMiroirSecondView#coerce));;
...
ignore (tableMirSecondView#attach ~left:1 ~top:1 (alignbboxMiroirRightLeftSecondView#coerce));;
...
ignore (tablebottomToolbarSecondView#attach ~left:2 ~top:0 (alignTableInversionSecondView#coerce));
ignore (tableInvSecondView#attach ~left:0 ~top:0 (bboxInversionSecondView#coerce));;
ignore (tablebottomToolbarSecondView#attach ~left:3 ~top:0 (alignTableCompressionSecondView#coerce));
ignore (tableCompressionSecondView#attach ~left:0 ~top:0  (bboxCompressionSecondView#coerce));;
ignore (tablebottomToolbarSecondView#attach ~left:4 ~top:0 (alignTableSegmentationSecondView#coerce));
ignore (tableSegmentationSecondView#attach ~left:0 ~top:0  (bboxSegmentationSecondView#coerce));;

ignore (confirmButtonConfirmer#connect#clicked (fun () -> ignore (alignConfirmation#misc#hide ()); ignore (thirdPageHBoxView1#misc#show ());
...
ignore (topToolbarSecondSeparator#misc#show ());ignore (topToolbarThirdSeparator#misc#show ());ignore (topToolbarReturnButton#misc#show ())));;

ignore (topToolbarReturnButton#connect#clicked (fun () -> ignore (thirdPageHBoxView1#misc#hide ());ignore (thirdPageVBoxview3#misc#hide ());Sys.remove (!tmpFileGlobalPath);
...
ignore (topToolbarRadioView1#connect#toggled (fun () -> ignore (thirdPageHBoxView1#misc#show ());ignore (thirdPageVBoxview3#misc#hide ())));;
ignore (topToolbarRadioview3#connect#toggled (fun () -> ignore (thirdPageHBoxView1#misc#hide ());ignore (thirdPageVBoxview3#misc#show ())));;
